...
public class AddGroupSpawnpointCommand implements CommandExecutor {

	private Plugin plugin;

	public String permission = "minigame.admin";
	public String message_successfull = ChatColor.GOLD + "Added a spawnpoint to group %group_display%" + ChatColor.GOLD + " in arena %arena%";
	...
	public AddGroupSpawnpointCommand(Plugin plugin) {
		this.plugin = plugin;
	}
