...
public class SetGroupSpawnCommand implements CommandExecutor {
	...
	public String message_successfull = ChatColor.GOLD + "Set spawn for group %group_display%" + ChatColor.GOLD + " in arena %arena%";
	...
	public SetGroupSpawnCommand(Plugin plugin) {
		this.plugin = plugin;
	}
